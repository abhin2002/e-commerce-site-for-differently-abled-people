...
import Redmi12 from '../images/redmi-12-1.jpeg'
const initialProducts = [  {    id: 1,    name: 'Google Pixel 4a',    description: 'Everything you love about Google',    likes: 10,audio:"",imageUrl:MobileImage1 },  {    id: 2,    name: 'HP Laptop 15s-fq5111TU',    description: 'Stay connected to what matters',    likes: 5,audio:"",imageUrl:LaptopImage1  },  {    id: 3,    name: 'Wakefit Three Seater',    description: 'Wakefit for the modern Indian household.',    likes: 7,audio:"",imageUrl:sofaset1  },  {    id: 4,    name: 'Product 4',    description: 'This is product 4',    likes: 2,audio:""  },  {    id: 5,    name: 'Product 5',    description: 'This is product 5',    likes: 3, audio:"" },  {    id: 6,    name: 'Product 6',    description: 'This is product 6',    likes: 8,audio:""  },  {    id: 7,    name: 'Product 7',    description: 'This is product 7',    likes: 6, audio:"" },  {    id: 8,    name: 'Product 8',    description: 'This is product 8',    likes: 12,audio:""  },{    id: 9,    name: 'Product 9',    description: 'This is product 9',    likes: 12,audio:""  },{    id: 10,    name: 'Product 10',    description: 'This is product 10',    likes: 12, audio:"" },{    id: 11,    name: 'Tomato-Blaby Special',    description: 'Perfectly round and smooth',    likes: 12,audio:"",imageUrl:tomato1 },{    id: 12,    name: 'Redmi 12 5G',    description: 'This is product 12',    likes: 12,audio:""  },{    id: 13,    name: 'Product 13',    description: 'This is product 13',    likes: 12,audio:""  },{    id: 14,    name: 'Product 14',    description: 'This is product 14',    likes: 12, audio:"" },{    id: 15,    name: 'Product 15',    description: 'This is product 15',    likes: 12,audio:""  },{    id: 16,    name: 'Product 16',    description: 'This is product 16',    likes: 12,audio:""  },{    id: 17,    name: 'Product 17',    description: 'This is product 17',    likes: 12, audio:"" },{    id: 18,    name: 'Product 18',    description: 'This is product 18',    likes: 12, audio:"" },{    id: 19,    name: 'Product 19',    description: 'This is product 19',    likes: 12, audio:"" }];
const Dashboard = () => {
